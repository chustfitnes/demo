...
export const store = {
  ...
  customers: [
    ...
    { _id: 'c3', name: 'Ideal Tovar MChJ', type: 'wholesale', phone: '+998 71 234 56 78', address: 'Buxoro', totalDebt: 4500000 }
  ],
  products: Array.from({ length: 15 }).map((_, i) => ({
    _id: `p${i+1}`,
    name: `Milano Classic Maxsulot ${i+1}`,
    artikul: `MIL-00${i+1}`,
    collection: 'Milano',
  ...
  orders: [
    {
      ...
      type: 'retail',
      items: [
        { product: { _id: 'p1', name: 'Milano Classic Maxsulot 1', artikul: 'MIL-001', category: 'oboi', brand: 'Milano' }, quantity: 10, unitPrice: 150000, subtotal: 1500000 }
      ],
    ...
    },
    {
      ...
      type: 'wholesale',
      items: [
        { product: { _id: 'p2', name: 'Milano Classic Maxsulot 2', artikul: 'MIL-002', category: 'oboi', brand: 'Milano' }, quantity: 50, unitPrice: 120000, subtotal: 6000000 }
      ],
