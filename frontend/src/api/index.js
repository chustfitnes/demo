...
export const uploadBrandingLogo   = (formData) => api.post('/settings/upload-logo', formData, {
  headers: { 'Content-Type': 'multipart/form-data' },
}).then(extractData);
// Logo o'chirish
export const deleteBrandingLogo   = () => api.delete('/settings/logo').then(extractData);
