      ...
      <div className="flex-1 flex flex-col h-full min-w-0 overflow-hidden relative">
        ...
        <header className="h-14 border-b border-subtle bg-surface flex items-center justify-between px-3 md:hidden shrink-0 z-30 relative shadow-sm">
          <div className="flex items-center gap-1.5">
            ...
            {branding.logoUrl ? (
              <img src={branding.logoUrl} alt={branding.storeName} className="w-[24px] h-[24px] object-contain ml-1 rounded" />
            ) : (
              <img src="/logo.png" alt="Logo" className="w-[20px] h-[20px] object-contain ml-1" />
            )}
            <span className="text-[15px] font-[600] tracking-tight text-primary ml-1">{branding.storeName || 'CRM'}</span>
          </div>
        </header>
