                ...
                <div className="flex items-center gap-3">
                  <div className="relative flex items-center group">
                    <input
                      ...
                      className="w-[200px] h-[42px] pl-3.5 pr-[52px] bg-app border border-subtle hover:border-default focus:border-focus rounded-xl text-[18px] font-[700] text-primary outline-none transition-all shadow-sm font-mono tracking-tight"
                    />
                    <div className="absolute right-1.5 top-1/2 -translate-y-1/2 flex items-center bg-surface p-0.5 rounded-lg border border-subtle shadow-sm">
                      <span className="px-2 py-1 text-[10px] font-[700] text-primary">UZS</span>
                    </div>
                  </div>
                  
                  {usdRate > 0 && (
                    <div className="text-[13px] font-[600] text-tertiary flex items-center gap-1.5">
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="opacity-60"><path d="m3 16 4 4 4-4"/><path d="M7 20V4"/><path d="m21 8-4-4-4 4"/><path d="M17 4v16"/></svg>
