  ...
  const navGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { to: "/reports", icon: BarChart2, label: "Hisobotlar", restrictedTo: ['superadmin', 'admin', 'manager'] },
      ],
    },
    {
      label: "SYSTEM",
    ...
    <>
      ...
      <div className="h-14 flex items-center justify-between px-5 border-b border-subtle shrink-0">
        <div className="flex items-center gap-2">
          {branding.logoUrl ? (
            <img src={branding.logoUrl} alt={branding.storeName} className="w-[22px] h-[22px] object-contain rounded" />
          ) : (
