          ...
          <div className="print:p-0 flex-1 overflow-y-auto bg-white no-scrollbar flex justify-center">
            ...
            <div className="flex flex-col items-center text-center mb-4">
              <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center mb-2 overflow-hidden">
                <img src={branding.logoUrl || '/logo.png'} alt="Logo" className="w-full h-full object-cover" onError={e => { e.target.src = '/logo.png'; }} />
              </div>
              <h2 className="text-lg font-bold uppercase tracking-wider mb-0.5 w-full">{(branding.storeName || 'DO\'KON').toUpperCase()}</h2>
