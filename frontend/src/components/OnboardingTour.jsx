  ...
  const steps = isMobile ? [
    {
      ...
      content: (
        <div>
          ...
          <p className="text-sm text-secondary">CRM tizimiga qisqacha sayohat uyushtiramiz. Bu dasturning imkoniyatlarini tezroq tushunib olishingizga yordam beradi.</p>
        </div>
      ),
      placement: 'center',
      disableBeacon: true,
